...
i=0
j=0
for i in len(these_coords):   
    xcord.append(these_coords[i][0])
for j in len(these_coords):   
    ycord.append(these_coords[j][1])
...
im = Image.open(r"C:\Users\hasan.uzunova\Desktop\tümfoto.png")
